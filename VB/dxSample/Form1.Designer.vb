...
'#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim zoomTransition2 As DevExpress.Utils.Animation.ZoomTransition = New DevExpress.Utils.Animation.ZoomTransition()
            ...
            AddHandler Me.winExplorerView1.ItemDoubleClick, New DevExpress.XtraGrid.Views.WinExplorer.WinExplorerViewItemDoubleClickEventHandler(AddressOf Me.winExplorerView1_ItemDoubleClick)
            AddHandler Me.winExplorerView1.ItemKeyDown, New DevExpress.XtraGrid.Views.WinExplorer.WinExplorerViewItemKeyDownEventHandler(AddressOf Me.winExplorerView1_ItemKeyDown)
            ' 
            ' columnName
            ' 
            ...
            Me.bar2.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.backButton), New DevExpress.XtraBars.LinkPersistInfo(Me.forwardButton), New DevExpress.XtraBars.LinkPersistInfo(Me.barEditItem1)})
            ...
            AddHandler Me.backButton.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.OnBackButtonClick)
            ' 
            ' forwardButton
            ' 
            ...
            AddHandler Me.forwardButton.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.OnForwardButtonClick)
            ' 
            ' barEditItem1
            ' 
            ...
            AddHandler Me.repositoryItemBreadCrumbEdit1.QueryChildNodes, New DevExpress.XtraEditors.BreadCrumbQueryChildNodesEventHandler(AddressOf Me.repositoryItemBreadCrumbEdit1_QueryChildNodes)
            AddHandler Me.repositoryItemBreadCrumbEdit1.ValidatePath, New DevExpress.XtraEditors.BreadCrumbValidatePathEventHandler(AddressOf Me.repositoryItemBreadCrumbEdit1_ValidatePath)
            AddHandler Me.repositoryItemBreadCrumbEdit1.NewNodeAdding, New DevExpress.XtraEditors.BreadCrumbNewNodeAddingEventHandler(AddressOf Me.repositoryItemBreadCrumbEdit1_NewNodeAdding)
            AddHandler Me.repositoryItemBreadCrumbEdit1.EditValueChanged, New System.EventHandler(AddressOf Me.OnBreadCrumbValueChanged)
            ' 
            ' barDockControlTop
            ' 
...
'#End Region
        ...
        Private backButton As DevExpress.XtraBars.BarButtonItem

        Private forwardButton As DevExpress.XtraBars.BarButtonItem

        Private barButtonItem1 As DevExpress.XtraBars.BarButtonItem

        Private barEditItem1 As DevExpress.XtraBars.BarEditItem

        Private repositoryItemBreadCrumbEdit1 As DevExpress.XtraEditors.Repository.RepositoryItemBreadCrumbEdit
    End Class
End Namespace
